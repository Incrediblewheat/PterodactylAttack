...
Ptero.scene_play = (function() {
	...
	function init() {
		...
		bountyBorderBtn = btns["bountyBorder"];
		bountyBorderBtn.shouldDraw = false;
		bountyContentBtn = btns["bountyContent"];
		bountyContentBtn.shouldDraw =  false;
